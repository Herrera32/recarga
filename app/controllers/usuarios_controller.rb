class UsuariosController < ApplicationController
    ...
    before_action :validar_captcha, only: %i[create update]
    ...
    def usuario_params
        params.require(:usuarios).permit(:id, :email, :password, :usuario, :telefono, :es_admin,
                                         :rols_id, :activo)
    end
